            ...
            <form onSubmit={handleLogin} className="card-body">
              ...
              <div className="form-control relative">
                ...
                <label className="label">
                  <a
                    href="#"
                    className="label-text-alt link link-hover text-[#2a5298]"
                  >
                    Forgot password?
                  </a>
                </label>
            ...
            <div className="mx-auto mb-4 ">
              <p>
                <button
                  ...
                  type="button"
                  className="text-white bg-[#1e3c72]   hover:bg-[#4285F4]/90 focus:ring-4   focus:outline-none  focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 mr-2 mb-2"
                >
                  <svg
