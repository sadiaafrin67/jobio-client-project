...
import animations from '../../assets/no data.json'
  ...
  return (
    <div>
      {filterUser && filterUser?.length === 0 ? (
        <div className="flex flex-col gap-3 justify-center items-center mt-10 mb-20">
         <Lottie className="max-w-md w-full text-center" animationData={animations}></Lottie>
         <p className="text-blue-700 font-bold text-2xl">You have not posted any job yet</p>
        </div>
